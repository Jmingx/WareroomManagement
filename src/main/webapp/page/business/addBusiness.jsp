    ...
    <form class="layui-form ok-form">
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-inline">
                ...
                <%--                模糊搜索--%>
                <select name="componentId" lay-filter="level1" lay-search="" lay-verify="required">
...
<script type="text/javascript">
    ...
    layui.use(["element","jquery", "form", "laydate", "okLayer", "okUtils"], function () {
        ...
        $.get('/component?type=show',null,function (data) {
            // alert(data.data);
            if (data.message === "succeed"){
                ...
                if (data.data != null){
                    ...
                    $("select[name=componentId]").append(html);
                    form.render('select')
                }else {
        ...
        form.on("submit(addApply)", function (data){
            ...
            okUtils.ajax("/business?type=insert", "get", data.field, true).done(function (response) {

                // console.log(response);
                // alert(response);
                if (response.message === "fail"){
                    layer.msg(response.message+" 增加事务操作将导致库存为负数！", {icon: 2, time: 3000}, function () {
                        // 刷新当前页table数据
