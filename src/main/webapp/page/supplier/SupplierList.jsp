...
<div class="ok-body">
    ...
    <div class="layui-row">
        <form class="layui-form layui-col-md12 ok-search">
            ...
            <input class="layui-input" id="supplierName" placeholder="供应商名称" autocomplete="off" name="name">
    ...
    layui.use(["element", "jquery", "okLayer", "form", "util", "okUtils", "table"], function () {
        ...
        let applyTable = table.render({
            ...
            cols: [[
                ...
                {field: "name", title: "供应商名称", width: 160, sort: true},
                {field: "contact", title: "联系方式", width: 160, sort: true},
        ...
        form.on('submit(search)', function (data) {
            applyTable = table.render({
                elem: '#applyTable',
                url: '/supplier?type=search&supplierName='+$("#supplierName").val(),
                limit: 20,
                page: true,
                toolbar: true,
                toolbar: '#toolbarApply',
        ...
        function batchDel() {
            okLayer.confirm("确定要批量删除吗？", function (index) {
                ...
                if (ids) {
                    okUtils.ajax("/supplier?type=batchDelete", "get", {"ids": ids}, true).done(function (rep) {
        ...
        function deleteApply(data) {
            okLayer.confirm("确定要删除吗？", function (index) {
                // okLayer.close(index);
                okUtils.ajax("/supplier?type=delete", "get", {id: data.id}, true).done(function (rep) {
                    okUtils.tableSuccessMsg(rep.message);
                }).fail(function (rep) {
                    console.log(rep);
                })
        ...
        function editApply(data) {
            okLayer.open("更新供应商信息", "/page/supplier/editSupplier.jsp", "90%", "90%", function (layero) {
        ...
        function buyDevice(data) {
            okLayer.open("增加供应商", "/page/supplier/addSupplier.jsp", "90%", "90%", function (layero) {
                let iframeWin = window[layero.find("iframe")[0]["name"]];
                iframeWin.initForm(data);
            }, function () {
                $(".layui-laypage-btn")[0].click();
        ...
        function openApply(data) {
            okLayer.open("申购单详情", "/page/supplier/openSupplier.jsp", "90%", "90%", function (layero) {
                let iframeWin = window[layero.find("iframe")[0]["name"]];
...
<script type="text/html" id="toolbarApply">
    <div class="layui-btn-container">
        ...
        <button class="layui-btn layui-btn-sm" lay-event="applyDevice">增加供应商</button>
    </div>
</script>
