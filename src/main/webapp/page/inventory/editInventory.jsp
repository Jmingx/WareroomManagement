...
<div class="ok-body">
    <form class="layui-form ok-form" lay-filter="editApply" >
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <input type="text" name="inventory" disabled placeholder="请输入库存量" autocomplete="off" class="layui-input" lay-verify="required|number">
            </div>
        </div>
        <div class="layui-form-item">
            <label class="layui-form-label">库存临界值</label>
            <div class="layui-input-block">
                <input type="number" name="criticalValue" placeholder="库存临界值" autocomplete="off" class="layui-input"
...
<script type="text/javascript">
    ...
    layui.use(["element","jquery", "form", "laydate", "okLayer", "okUtils"], function () {
        ...
        form.on("submit(edit)", function (data){
            ...
            okUtils.ajax("/inventory?type=update", "get", data.field, true).done(function (response) {



                if (response.message === "fail"){

                    layer.msg(response.message+" 库存临界值不能小于或等于0", {icon: 2, time: 3000}, function () {
                        // 刷新当前页table数据
